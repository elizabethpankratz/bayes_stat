...
```{r}
unif_plot_list <- generate_betabinom_plots(1, 1, obs_seq_100[1:8], ymax = 3.5, obs_in_title = TRUE)
inform_plot_list <- generate_betabinom_plots(20, 20, obs_seq_100[1:8], ymax = 5.75,  obs_in_title = TRUE)
```
...
gifski::save_gif(make_unif_plots(), path_to_gif, 1000, 720, res = 144, delay=1)
```
